# Generated by Django 2.2.12 on 2020-06-28 20:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alignment', models.CharField(choices=[('NG', 'Neutral Good'), ('LG', 'Lawful Good'), ('LN', 'Lawful Neutral'), ('CN', 'Chaotic Neutral'), ('LE', 'Lawful Evil'), ('CE', 'Chaotic Evil'), ('NE', 'Neutral Evil'), ('NN', 'True Neutral'), ('CG', 'Chaotic Good')], max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='AmmoType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.CharField(choices=[('FEET', 'Feet'), ('TORSO', 'Torso'), ('HEAD', 'Head'), ('NECK', 'Neck'), ('LEGS', 'Legs'), ('EYE', 'Eye')], max_length=50)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('item_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='player.Item')),
                ('area', models.CharField(choices=[('2H', 'Two Handed'), ('1H', 'One Handed')], max_length=2)),
            ],
            options={
                'abstract': False,
            },
